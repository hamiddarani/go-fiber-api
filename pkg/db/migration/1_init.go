...
var logger = logging.NewLogger(config.Load(true).Logger)
...
func createDefaultUserInformation(database *gorm.DB) {
	...
	adminRole := models.Role{Name: utils.AdminRoleName}
	createRoleIfNotExists(database, &adminRole)

	defaultRole := models.Role{Name: utils.DefaultRoleName}
